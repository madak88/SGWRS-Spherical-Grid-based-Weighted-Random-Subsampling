...
class Kitti(Dataset):
    ...
    def __init__(self, data_root, split, pts_prefix='velodyne_reduced'):
        ...
        db_infos = read_pickle(os.path.join(data_root, 'kitti-reduced_dbinfos_train.pkl'))
    ...
    def __getitem__(self, index):
        ...
        if self.split in ['train', 'trainval']:
            data_dict = data_augment(self.CLASSES, self.data_root, data_dict, self.data_aug_config, data_info)
        else:
